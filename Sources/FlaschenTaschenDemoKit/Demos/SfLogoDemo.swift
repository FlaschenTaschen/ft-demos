...
// sf-logo - Sequoia Fabrica logo animation from SVG
// Renders logo with line-based drawing (like hack font) and 3D rotation
...
public struct SfLogoDemo: Sendable {
    ...
    public static func run(options: Options, canvas: UDPFlaschenTaschen) async {
        let logger = Logger(subsystem: Logging.subsystem, category: "sf-logo")
