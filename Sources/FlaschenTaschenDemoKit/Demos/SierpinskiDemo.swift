...
// sierpinski - Sierpinski Triangle fractal using chaos game algorithm
// Ported from sierpinski.cc
...
public struct SierpinskiDemo: Sendable {
    ...
    public static func run(options: Options, canvas: UDPFlaschenTaschen) async {
        let logger = Logger(subsystem: Logging.subsystem, category: "sierpinski")
