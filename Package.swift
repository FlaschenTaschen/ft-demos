...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/FlaschenTaschen/ft-clients.git", branch: "main"),
    ],
    targets: [
        // FlaschenTaschenDemoKit Library
        .target(
            name: "FlaschenTaschenDemoKit",
            dependencies: [
                .product(name: "FlaschenTaschenClientKit", package: "ft-clients"),
            ]
        ),
